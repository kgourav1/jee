...
getNewQuestion = () => {
  ...
  question.innerHTML = currentQuestion.question; // Directly sets question content
  ...
  // Call MathJax to re-render the LaTeX content in the current question and choices
  MathJax.typesetPromise()
    .then(() => {
      console.log("MathJax content re-rendered for new question.");
    })
